import { assessPedigreeCompleteness } from "./blood-features.mjs";
...
const assessDataQuality = (horse) => {
  ...
  const pedigreeCompleteness = assessPedigreeCompleteness(horse);
  ...
  const reasons = [
    ...
    hasPedigree ? pedigreeCompleteness.label : "血統情報が不足",
