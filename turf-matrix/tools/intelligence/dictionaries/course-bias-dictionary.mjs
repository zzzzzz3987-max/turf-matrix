...
const COURSE_BIAS_PROFILES = [
  {
    ...
    bloodMajorTags: ["小回り", "持続戦", "スタミナ", "パワー"],
  ...
  },
  {
    ...
    bloodMajorTags: ["小回り", "高速馬場", "立ち回り", "機動力"],
  ...
  },
  {
    ...
    bloodMajorTags: ["洋芝", "パワー", "スタミナ", "持続戦"],
  ...
  },
  {
    ...
    label: "札幌芝1800m",
    sourceRefs: [
      "https://www.jra.go.jp/facilities/race/sapporo/course/",
      "https://keiba-course.com/course/sapporo-turf-1800/",
    ],
    summary: "ほぼ平坦な洋芝の小回りで、4つのコーナーと短い直線を使うコース。パワー、持続力、先行力と機動力を評価します。",
    shape: {
      turn: "right",
      layout: "small",
      corners: 4,
    ...
    traits: { speed: 0.62, power: 0.92, stamina: 0.76, sustain: 0.88 },
    styleBias: ["逃げ", "先行", "捲り", "立ち回り型"],
    bloodBias: ["Kingmambo系", "Harbinger系", "Heart's Cry系", "Roberto系"],
    bloodBiasIds: ["kingmambo", "harbinger", "heart_cry", "roberto", "deep_impact"],
    bloodMajorTags: ["洋芝", "小回り", "パワー", "持続戦", "立ち回り"],
    bloodFitTags: ["洋芝", "小回り", "パワー", "持続戦", "立ち回り", "先行", "中距離"],
    caution: ["後方一気は展開依存", "洋芝適性とコーナーでの機動力を確認"],
  },
  {
    ...
    bloodMajorTags: ["洋芝", "小回り", "パワー", "持続戦", "スタミナ"],
  ...
  },
  {
    ...
    summary: "日本唯一の芝直線1000m。野芝の高速条件で、純粋なスピード、加速、先行持続力を最優先で評価します。",
    shape: {
      turn: "straight",
      layout: "straight",
      corners: 0,
      straight: "full_course",
      hill: "mostly_flat",
      turf: "warm_season",
    },
    traits: { speed: 1, power: 0.62, stamina: 0.22, sustain: 0.7 },
    styleBias: ["逃げ", "先行", "スピード持続型"],
    bloodBias: ["Hennessy・ヘニーヒューズ系", "Taiki Shuttle系", "Mr. Prospector系", "Danzig系", "Grey Sovereign系"],
    bloodBiasIds: ["hennessy_sprint", "taiki_shuttle_sprint", "mr_prospector", "danzig", "northern_dancer", "grey_sovereign"],
    bloodMajorTags: ["高速馬場", "短距離", "スピード", "トップスピード"],
    bloodFitTags: ["高速馬場", "平坦", "短距離", "機動力", "先行", "スピード", "トップスピード"],
    caution: ["枠順確定後に外枠バイアスを別評価", "中長距離型のスタミナだけでは評価しない"],
  },
  {
    ...
    bloodMajorTags: ["長い直線", "高速馬場", "瞬発力", "トップスピード"],
  ...
  },
  {
    ...
    bloodMajorTags: ["平坦", "高速馬場", "立ち回り", "機動力"],
